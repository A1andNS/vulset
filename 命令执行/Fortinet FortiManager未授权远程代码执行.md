# Fortinet FortiManager未授权远程代码执行.md

## 简介
此 Metasploit 模块利用影响 FortiManager 和 FortiManager Cloud 设备的缺失身份验证漏洞，以 root 权限实现未经身份验证的 RCE。存在漏洞的 FortiManager 版本为 7.6.0、7.4.0 至 7.4.4、7.2.0 至 7.2.7、7.0.0 至 7.0.12、6.4.0 至 6.4.14 和 6.2.0 至 6.2.12。存在漏洞的 FortiManager Cloud 版本为 7.4.1 至 7.4.4、7.2.1 至 7.2.7、7.0.1 至 7.0.12 和 6.4（所有版本）。

> 漏洞编号：CVE-2024-47575
> 等级：致命
> 影响范围：FortiManager多版本
